...
/* Temporary changes to outside of CONFIG_HUAWEI_CAMERA
// delete if success
#ifdef CONFIG_HUAWEI_SENSOR_MT9E013
...
//Delete comment if operation success
//#ifdef CONFIG_HUAWEI_SENSOR_MT9E013
static struct msm_camera_sensor_flash_data flash_mt9e013 = {
	.flash_type = MSM_CAMERA_FLASH_LED,
	.flash_src  = &msm_flash_src_pwm
...
static int __init buses_init(void)
{
		...
		|| machine_is_msm8255_u8800_pro())
	{
		pm8058_7x30_data.keypad_pdata = &fluid_keypad_data;
			...
			|| machine_is_msm8255_u8860_51())
    {
        pm8058_7x30_data.keypad_pdata = &fluid_norow_keypad_data;
    }
    else {
...
//extern int sdcc_wifi_slot;	//delete if no error occur
	...
	else if (machine_is_msm8255_u8680())
    {
        ...
        else
        {
    	    buf_vkey_size = sprintf(buf_virtualkey,
        		       ...
        		       ":" __stringify(EV_KEY) ":" __stringify(KEY_HOMEPAGE)   ":180:840:112:70"
        		       ":" __stringify(EV_KEY) ":" __stringify(KEY_BACK)   ":300:840:112:70"
        		       ":" __stringify(EV_KEY) ":" __stringify(KEY_SEARCH) ":430:840:112:70"
        		       "\n");
        }
...
out2:
	...
	//sdcc_wifi_slot = 3; //delete if no error occured
#ifdef CONFIG_HUAWEI_WIFI_SDCC
