...
{
    /* < DTS2011121401573 zhouqiwei 20111214 begin */
    ...
    {0x10, 0x01},
    {0x12, 0x30},
    /*< DTS2011120807747 yuguangcai 20120109 begin */
    /*to increase shading*/
    {0x40, 0x31}, //0x2a
    /* DTS2011120807747 yuguangcai 20120109 end > */
    {0x41, 0x05},
    {0x50, 0x90},
    {0x60, 0x1f},
    {0x61, 0xba}, //a6->b6
    ...
    {0x10, 0xdc},
    {0x01, 0xf0},
    /* < DTS2011121401573 zhouqiwei 20111214 end > */
};
/* DTS2011111901010 zhouqiwei  20111130 end > */
...
static struct hi701_i2c_reg_conf hi701_effect_sepia_reg_config[] =
{
    ...
    /*< DTS2011122000761 yuguangcai 20120109 begin */
    /*increase Red ratio*/
    {0x13, 0x00}, {0x44, 0x60}, {0x45, 0x98},
    /* DTS2011122000761 yuguangcai 20120109 end > */
    {0x47, 0x7f}, {0x20, 0x07}, {0x21, 0x03},
};
                              ...
                              struct msm_sensor_ctrl *             s)
{
    ...
    /* < DTS2012052805130 cuixuefeng 20120529 begin */
    /* < DTS2011123006304 zhouqiwei 20120109 begin */
    s->s_mount_angle = 270;
    /* DTS2011123006304 zhouqiwei 20120109 end > */
    /* DTS2012052805130 cuixuefeng 20120529 end > */
